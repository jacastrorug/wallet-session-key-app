...
import AuthCustomJWT from "./components/AuthCustomJWT";
...
export default function Home() {
  ...
  const {
    signWithSessionKey,
    isLoading: isSigningWithSessionKey,
    error: sessionKeySignError,
  } = useSessionKeySigner();
  ...
  } = useEthBalance(smartAccountResult?.accountAddress || null);
  ...
  const [selectedPermissionType, setSelectedPermissionType] = useState<
    "root" | "native-token-transfer" | "erc20-token-transfer"
  >("root");
  ...
  const pollForTransactionHash = async (callId: string): Promise<string> => {
    ...
    for (let attempt = 0; attempt < maxAttempts; attempt++) {
      try {
        ...
        if (
          ...
          const receipt = status.receipts[0] as {
    ...
    setIsPollingForHash(false);
    throw new Error(
      "Transaction hash not found after maximum polling attempts"
    );
  };
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-mono font-semibold text-blue-900">
                        {smartAccountResult.accountAddress.slice(0, 6)}...
                        {smartAccountResult.accountAddress.slice(-4)}
                      </p>
                      <button
                        onClick={() =>
                          handleCopy(
                            smartAccountResult.accountAddress,
                            "sidebar-smart-account"
                          )
                        }
                      ...
                      >
                        {copiedItems.has("sidebar-smart-account")
                          ? "Copied!"
                          : "Copy"}
                      </button>
                    </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M4 2a2 2 0 00-2 2v11a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2H4zm3 2h10a1 1 0 011 1v9a1 1 0 01-1 1H7V4z"
                        clipRule="evenodd"
                      />
                    </svg>
                    Alchemy Sandbox
              ...
              >
                <div className="mb-3">
                  <div className="flex items-center justify-between">
                    ...
                    {isStepCompleted(1) && (
                      <button
                        ...
                        title={
                          isStepCollapsed(1) ? "Expand step" : "Collapse step"
                        }
                      >
                        <svg
                          className={`w-5 h-5 transition-transform duration-200 ${
                            isStepCollapsed(1) ? "rotate-180" : ""
                          }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    SDK Hook:{" "}
                    <a
                      href="https://www.alchemy.com/docs/wallets/reference/account-kit/react/hooks/useSigner"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <div
                  className={`transition-all duration-300 ease-in-out ${
                    isStepCollapsed(1) ? "max-h-0 overflow-hidden" : "max-h-96"
                  }`}
                >
                  {!isStepCompleted(1) && (
                    <button
                  ...
                  {signerAddress && (
                    <div className="bg-green-100 p-3 rounded mt-3">
                      <p className="text-green-800 font-semibold text-base">
                        Signer Address Retrieved!
                      </p>
                      <div className="flex items-center gap-2 mt-2">
                        <p className="text-sm">
                          <strong>Address:</strong> {signerAddress.slice(0, 6)}
                          ...{signerAddress.slice(-4)}
                        </p>
                        <button
                          onClick={() =>
                            handleCopy(signerAddress, "signer-address")
                          }
                          className="text-xs bg-green-200 hover:bg-green-300 px-2 py-1 rounded cursor-pointer transition-colors"
                        >
                          {copiedItems.has("signer-address")
                            ? "Copied!"
                            : "Copy"}
                        </button>
                      </div>
              ...
              >
                <div className="mb-3">
                  <div className="flex items-center justify-between">
                    ...
                    {isStepCompleted(2) && (
                      <button
                        ...
                        className="p-1 text-gray-500 hover:text-gray-700 transition-colors cursor-pointer"
                        title={
                          isStepCollapsed(2) ? "Expand step" : "Collapse step"
                        }
                      >
                        <svg
                          className={`w-5 h-5 transition-transform duration-200 ${
                            isStepCollapsed(2) ? "rotate-180" : ""
                          }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    API Endpoint:{" "}
                    <a
                      href="https://docs.alchemy.com/reference/wallet-requestaccount"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                ...
                <div
                  className={`transition-all duration-300 ease-in-out ${
                    isStepCollapsed(2) ? "max-h-0 overflow-hidden" : "max-h-96"
                  }`}
                >
                  {!isStepCompleted(2) && (
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          console.error(
                            "Error requesting smart account:",
                            error
                          );
                        }
                      }}
                    ...
                    <div className="bg-green-100 p-3 rounded mt-3">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <button
                          ...
                          className="text-xs bg-green-200 hover:bg-green-300 px-2 py-1 rounded cursor-pointer transition-colors"
                        >
                          {copiedItems.has("smart-account-address")
                            ? "Copied!"
                            : "Copy"}
                        </button>
                      </div>
                      <div className="flex items-center gap-2 mt-1">
                        <p className="text-sm">
                          <strong>ID:</strong>{" "}
                          {smartAccountResult.id.slice(0, 6)}...
                          {smartAccountResult.id.slice(-4)}
                        </p>
                        <button
                          onClick={() =>
                            handleCopy(
                              smartAccountResult.id,
                              "smart-account-id"
                            )
                          }
                          className="text-xs bg-green-200 hover:bg-green-300 px-2 py-1 rounded cursor-pointer transition-colors"
                        >
                          {copiedItems.has("smart-account-id")
                            ? "Copied!"
                            : "Copy"}
                        </button>
                      </div>
              ...
              >
                <div className="mb-3">
                  <div className="flex items-center justify-between">
                    ...
                    {isStepCompleted(3) && (
                      <button
                        ...
                        className="p-1 text-gray-500 hover:text-gray-700 transition-colors cursor-pointer"
                        title={
                          isStepCollapsed(3) ? "Expand step" : "Collapse step"
                        }
                      >
                        <svg
                          className={`w-5 h-5 transition-transform duration-200 ${
                            isStepCollapsed(3) ? "rotate-180" : ""
                          }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    API Endpoint:{" "}
                    <a
                      href="https://docs.alchemy.com/reference/wallet-createsession"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center">
                        <input
                          ...
                          onChange={(e) =>
                            setSelectedPermissionType(e.target.value as "root")
                          }
                          className="mr-2"
                        />
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          checked={
                            selectedPermissionType === "native-token-transfer"
                          }
                          onChange={(e) =>
                            setSelectedPermissionType(
                              e.target.value as "native-token-transfer"
                            )
                          }
                          className="mr-2"
                        />
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          checked={
                            selectedPermissionType === "erc20-token-transfer"
                          }
                          onChange={(e) =>
                            setSelectedPermissionType(
                              e.target.value as "erc20-token-transfer"
                            )
                          }
                          className="mr-2"
                        />
                        <span className="text-sm text-gray-700">
                          <strong>ERC20 Token Transfer</strong> - Transfer ERC20
                          tokens
                        </span>
                      </label>
                    </div>
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center">
                        <input
                          ...
                          onChange={(e) =>
                            setSelectedSessionTime(e.target.value as "5min")
                          }
                          className="mr-2"
                        />
                        <span className="text-sm text-gray-700">
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          onChange={(e) =>
                            setSelectedSessionTime(e.target.value as "1hour")
                          }
                          className="mr-2"
                        />
                        <span className="text-sm text-gray-700">
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          onChange={(e) =>
                            setSelectedSessionTime(e.target.value as "1day")
                          }
                          className="mr-2"
                        />
                        <span className="text-sm text-gray-700">
                ...
                <div
                  className={`transition-all duration-300 ease-in-out ${
                    isStepCollapsed(3) ? "max-h-0 overflow-hidden" : "max-h-96"
                  }`}
                >
                  {!isStepCompleted(3) && (
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          if (!smartAccountResult?.accountAddress) {
                            console.error(
                              "No smart account available. Please create one first."
                            );
                            return;
                          }
                          ...
                          await createSession({
                            ...
                            expiry:
                              ...
                              getSessionTimeInSeconds(selectedSessionTime), // Use selected session time
                    ...
                    <div className="bg-blue-100 p-3 rounded mt-3">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <p className="text-sm">
                          ...
                          {sessionResult.sessionId.slice(0, 6)}...
                          {sessionResult.sessionId.slice(-4)}
                        </p>
                        <button
                          onClick={() =>
                            handleCopy(sessionResult.sessionId, "session-id")
                          }
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <p className="text-sm">
                          ...
                          {sessionResult.sessionKey.address.slice(0, 6)}...
                          {sessionResult.sessionKey.address.slice(-4)}
                        </p>
                        <button
                          onClick={() =>
                            handleCopy(
                              sessionResult.sessionKey.address,
                              "session-key-address"
                            )
                          }
                          className="text-xs bg-blue-200 hover:bg-blue-300 px-2 py-1 rounded cursor-pointer transition-colors"
                        >
                          {copiedItems.has("session-key-address")
                            ? "Copied!"
                            : "Copy"}
                        </button>
                      </div>
                      <p className="text-sm mt-1">
                        ...
                        {sessionResult.signatureRequest.type}
                      </p>
                      <p className="text-sm mt-1">
              ...
              >
                <div className="mb-3">
                  <div className="flex items-center justify-between">
                    ...
                    {isStepCompleted(4) && (
                      <button
                        ...
                        className="p-1 text-gray-500 hover:text-gray-700 transition-colors cursor-pointer"
                        title={
                          isStepCollapsed(4) ? "Expand step" : "Collapse step"
                        }
                      >
                        <svg
                          className={`w-5 h-5 transition-transform duration-200 ${
                            isStepCollapsed(4) ? "rotate-180" : ""
                          }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    SDK Hook:{" "}
                    <a
                      href="https://www.alchemy.com/docs/wallets/reference/account-kit/wallet-client/functions/signTypedData"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                      <code className="bg-gray-200 px-1 rounded text-xs">
                        useSigner().signTypedData()
                      </code>
                    </a>
                  </p>
                </div>
                ...
                <div
                  className={`transition-all duration-300 ease-in-out ${
                    isStepCollapsed(4) ? "max-h-0 overflow-hidden" : "max-h-96"
                  }`}
                >
                  {!isStepCompleted(4) && (
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          console.error(
                            "Error signing session authorization:",
                            error
                          );
                        }
                      }}
                  ...
                  {authorizationResult && (
                    <div className="bg-purple-100 p-3 rounded mt-3">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <p className="text-sm">
                          <strong>Session ID:</strong>{" "}
                          {authorizationResult.sessionId.slice(0, 6)}...
                          {authorizationResult.sessionId.slice(-4)}
                        </p>
                        <button
                          onClick={() =>
                            handleCopy(
                        ...
                        >
                          {copiedItems.has("auth-session-id")
                            ? "Copied!"
                            : "Copy"}
                        </button>
                      </div>
                      <div className="flex items-center gap-2 mt-1">
                        <p className="text-sm">
                          ...
                          {authorizationResult.signature.slice(0, 6)}...
                          {authorizationResult.signature.slice(-4)}
                        </p>
                        <button
                          onClick={() =>
                            handleCopy(
                          ...
                          className="text-xs bg-purple-200 hover:bg-purple-300 px-2 py-1 rounded cursor-pointer transition-colors"
                        >
                          {copiedItems.has("auth-signature")
                            ? "Copied!"
                            : "Copy"}
                        </button>
                      </div>
                      <div className="flex items-center gap-2 mt-1">
                        <p className="text-sm">
                          ...
                          {authorizationResult.authorization.slice(0, 6)}...
                          {authorizationResult.authorization.slice(-4)}
                        </p>
                        <button
                          onClick={() =>
                            handleCopy(
                          ...
                          className="text-xs bg-purple-200 hover:bg-purple-300 px-2 py-1 rounded cursor-pointer transition-colors"
                        >
                          {copiedItems.has("auth-authorization")
                            ? "Copied!"
                            : "Copy"}
                        </button>
                      </div>
              ...
              >
                <div className="mb-3">
                  <div className="flex items-center justify-between">
                    ...
                    {isStepCompleted(5) && (
                      <button
                        ...
                        className="p-1 text-gray-500 hover:text-gray-700 transition-colors cursor-pointer"
                        title={
                          isStepCollapsed(5) ? "Expand step" : "Collapse step"
                        }
                      >
                        <svg
                          className={`w-5 h-5 transition-transform duration-200 ${
                            isStepCollapsed(5) ? "rotate-180" : ""
                          }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    API Endpoint:{" "}
                    <a
                      href="https://docs.alchemy.com/reference/wallet-preparecalls"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                ...
                <div
                  className={`transition-all duration-300 ease-in-out ${
                    isStepCollapsed(5) ? "max-h-0 overflow-hidden" : "max-h-96"
                  }`}
                >
                  {!isStepCompleted(5) && (
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          if (
                            ...
                            console.error(
                              "Missing required data from previous steps"
                            );
                            return;
                          }
                  ...
                  {prepareCallsError && (
                    <p className="text-red-500 text-sm mt-2">
                      Prepare Calls Error: {prepareCallsError}
                    </p>
                  )}
                      ...
                      <div className="mt-3">
                        ...
                        <div className="bg-orange-50 p-2 rounded text-xs space-y-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-mono">
                              {prepareCallsResult.chainId}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="font-medium">Sender:</span>
                            <span className="font-mono">
                              {prepareCallsResult.userOpRequest.sender?.slice(
                                0,
                                6
                              )}
                              ...
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-mono">
                              {prepareCallsResult.userOpRequest.nonce}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="font-medium">Call Gas Limit:</span>
                            <span className="font-mono">
                              {prepareCallsResult.userOpRequest.callGasLimit}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-mono">
                              {prepareCallsResult.userOpRequest.maxFeePerGas}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-3">
                        ...
                        <div className="bg-orange-50 p-2 rounded text-xs space-y-1">
                          <div className="flex items-center gap-2">
                            <span className="font-medium">Type:</span>
                            <span className="font-mono">
                              {prepareCallsResult.signatureRequest.type}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="font-medium">Hash to Sign:</span>
                            <span className="font-mono">
                              {prepareCallsResult.signatureRequest.data.raw.slice(
                                0,
                                6
                              )}
                              ...
              ...
              >
                <div className="mb-3">
                  <div className="flex items-center justify-between">
                    ...
                    {isStepCompleted(6) && (
                      <button
                        ...
                        className="p-1 text-gray-500 hover:text-gray-700 transition-colors cursor-pointer"
                        title={
                          isStepCollapsed(6) ? "Expand step" : "Collapse step"
                        }
                      >
                        <svg
                          className={`w-5 h-5 transition-transform duration-200 ${
                            isStepCollapsed(6) ? "rotate-180" : ""
                          }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    API Endpoint:{" "}
                    <a
                      href="https://docs.alchemy.com/reference/wallet-sendpreparedcalls"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                ...
                <div
                  className={`transition-all duration-300 ease-in-out ${
                    isStepCollapsed(6) ? "max-h-0 overflow-hidden" : "max-h-96"
                  }`}
                >
                  {!isStepCompleted(6) && (
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          if (
                            ...
                            console.error(
                              "Missing prepared calls, session data, or session key"
                            );
                            return;
                          }
                          ...
                          if (response && typeof response === "object") {
                            if (
                              response.preparedCallIds &&
                              Array.isArray(response.preparedCallIds)
                            ) {
                          ...
                          if (callIds && callIds.length > 0) {
                            ...
                            console.log(
                              "Starting to poll for transaction hash with call ID:",
                              callId
                            );

                            try {
                              const txHash = await pollForTransactionHash(
                                callId
                              );
                              console.log("Final transaction hash:", txHash);
                            } catch (pollError) {
                              console.error(
                                "Error polling for transaction hash:",
                                pollError
                              );
                            }
                          } else {
                            console.error(
                              "No call IDs found in response:",
                              response
                            );
                          }
                  ...
                  {sessionKeySignError && (
                    <p className="text-red-500 text-sm mt-2">
                      Session Key Sign Error: {sessionKeySignError}
                    </p>
                  )}
                          ...
                          {sendCallsError.includes(
                            ...
                            <div className="mt-2 p-2 bg-red-100 rounded border border-red-200">
                              ...
                              <ol className="text-red-700 text-xs mt-1 ml-4 list-decimal">
                                <li>
                                  Copy the smart account address from Step 2
                                </li>
                                <li>
                                  Send Sepolia ETH to that address using a
                                  faucet or exchange
                                </li>
                                <li>
                                  You can use{" "}
                                ...
                                <li>
                                  Try Step 6 again once the account has ETH
                                </li>
                              </ol>
                            </div>
                          )}
                  ...
                  {isPollingForHash && (
                    <div className="bg-blue-100 p-3 rounded mt-3">
                      ...
                      <p className="text-blue-700 text-xs mt-1">
                        This may take a few moments while the transaction is
            ...
            <div className="sticky top-6 flex flex-col h-[calc(100vh-3rem)]">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Sign in to explore session key functionality with Alchemy
                  Smart Wallets
                </p>
